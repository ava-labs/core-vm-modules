...
export const CoinsContractInfoResponseSchema = object({
  ...
  links: object({
    ...
    repos_url: record(string(), string().array().nullable()).nullable().optional(),
  })
    .nullable()
    .optional(),
  image: object({
  ...
  market_data: object({
    ...
    ath_change_percentage: record(string(), number().nullable()).nullable().optional(),
    ath_date: record(string(), string()).nullable().optional(),
    atl: record(string(), number().nullable()).nullable().optional(),
    atl_change_percentage: record(string(), number().nullable()).nullable().optional(),
    atl_date: record(string(), string().nullable()).nullable().optional(),
    market_cap: record(string(), number().nullable()).nullable().optional(),
    market_cap_rank: number().nullable().optional(),
    fully_diluted_valuation: record(string(), number().nullable()).nullable().optional(),
    total_volume: record(string(), number().nullable()).nullable().optional(),
    total_value_locked: record(string(), number().nullable()).nullable().optional(),
...
export type CoinsContractInfoResponse = z.infer<typeof CoinsContractInfoResponseSchema>;

export type CoinsInfoResponse = Omit<CoinsContractInfoResponse, 'contract_address'>;
