...
import { parseDisplayDataTitle } from './parse-display-data-title';
...
describe('parse-display-data-title', () => {
  it('should return title Sign Message for unknwon tx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.UnknownTx);
  ...
  it('should return title Add Delegator for AddPermissionlessDelegatorTx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.AddPermissionlessDelegatorTx);
  ...
  it('should return title Add Subnet Validator for AddSubnetValidatorTx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.AddSubnetValidatorTx);
  ...
  it('should return title Approve Create Chain for CreateChainTx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.CreateChainTx);
  ...
  it('should return title Approve Create Subnet for CreateSubnetTx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.CreateSubnetTx);
  ...
  it('should return title Remove Subnet Validator for RemoveSubnetValidatorTx', () => {
    ...
    const title = parseDisplayDataTitle({ ...tx } as Avalanche.RemoveSubnetValidatorTx);
